...
Magics = Enum("MAGIC", ["CHARGE", "THERMAL"])

PlayerFlags = Flags(
    "PLAYERFLAG",
    ["ADMIN", "CHATTING", "SCOREBOARD", "READY", "DEAD", "WATCHING", "BOT"],
)
...
Messages = [
    ...
    NetMessage("Sv_CommandInfoRemove", [NetStringStrict("m_Name")]),
    NetMessage(
